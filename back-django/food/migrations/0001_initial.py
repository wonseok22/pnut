# Generated by Django 3.2.18 on 2023-03-24 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail_image_url', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='BoardSteps',
            fields=[
                ('board_steps_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_name', models.CharField(blank=True, max_length=16, null=True)),
            ],
            options={
                'db_table': 'category',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('commnet_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='FoodIngre',
            fields=[
                ('food_ingre_id', models.BigIntegerField(primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'food_ingre',
                'managed': False,
        ...
        migrations.CreateModel(
            name='FoodNut',
            fields=[
                ('fod_nut_id', models.BigIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='NutIngre',
            fields=[
                ('nut_ingre_id', models.BigAutoField(primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'nut_ingre',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Nutrient',
            fields=[
                ('nutrient_id', models.BigAutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=45)),
                ('guide', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            name='RecipeSteps',
            fields=[
                ('recipe_steps_id', models.BigAutoField(primary_key=True, serialize=False)),
                ('image_url', models.CharField(blank=True, max_length=45, null=True)),
                ('content', models.CharField(blank=True, max_length=200, null=True)),
                ('recipe_stepscol', models.CharField(blank=True, max_length=45, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_image_url', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            name='UserSymptom',
            fields=[
                ('user_symptom_id', models.BigAutoField(primary_key=True, serialize=False)),
